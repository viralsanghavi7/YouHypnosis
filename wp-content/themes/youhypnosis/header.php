    ...
    <div class="container"> <a href="http://localhost:8888/youhypnosis/" class="logo"> <img src="<?php bloginfo('template_directory'); ?>/images/logo.jpg"> </a>
      ...
      <nav id="mainMenu">
        <ul>
          ...
          <li class="submainMenu"> <a href="#" onClick="return false;"> About us <i class="fa fa-angle-down d-none d-lg-block d-md-block" aria-hidden="true"></i> </a> <i class="fa fa-angle-right mobile-arrow d-lg-none d-md-none" aria-hidden="true"></i>
            <ul class="submenu">
